...
function adjustVideoSize() {
    videoReady = false;
    videoWidth = Math.floor((window.innerWidth*0.15));
    videoHeight = min(Math.floor(videoWidth * aspectRatio), window.innerHeight*0.12);
    ...
    document.getElementById("log").innerText = videoHeight;
    videoReady = true;
}
