async function init() {
    ...
    function writeUniforms() {
        ...
        u32[20] = (addrMode >>> 0);   // Camera.addrMode
        u32[21] = (filterMode >>> 0);   // Camera.filterMode
        u32[22] = (texturingOn >>> 0);  // Camera._pad1 used as "texturingOn"
        u32[23] = 0;                    // Camera._pad2 (unused)
